...
def category_list(request):
    ...
    return render(request, 'store/categories.html', context={'categories': categories,})
...
def category_detail(request, pk):
    ...
    return render(
         request, 'store/category_detail.html',
           context={'product_list': build_template(products, 3),
                     'category': category} 
           )
...
def save_order(request):
    ...
    order.save()
    return render(request, 'store/order.html', context={'order': order})